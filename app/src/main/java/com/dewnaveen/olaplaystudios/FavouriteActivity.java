...
public class FavouriteActivity extends AppCompatActivity implements PlayCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Realm realm = null;
        RealmResults<RMSongFavourite> realmResults = null;
        try {
        ...
        if (realmResults != null) {
            ...
            RecViewSongsFavAdapter recViewSongsAdapter = new RecViewSongsFavAdapter(realmResults, mAct, playCallback);
            rv_songs.setLayoutManager(new LinearLayoutManager(mAct));
            rv_songs.setAdapter(recViewSongsAdapter);
        }else{
            Toasty.error(mAct,"No Favourite Song found", Toast.LENGTH_LONG).show();
        }
    ...
    private void initToolbar() {
        ...
        tv_toolTitle.setText("Favourite List");
